...
电子补充材料 本章的在线版本（doi:[10.1007/978-1-4842-1672-9_1](http://dx.doi.org/10.1007/978-1-4842-1672-9_1)）包含补充材料，授权用户可获取。
...
好的，作为高级文档工程师和翻译员，我将遵循您提供的注意事项和示例，将给定的英文文本准确地翻译成中文。
...
| `shipping_zipcode` | `varchar(10)` | 存储需要送货地区的邮政编码。 |
