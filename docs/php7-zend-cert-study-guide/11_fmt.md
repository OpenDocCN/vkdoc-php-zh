...
| `debug_print_backtrace` | 打印回溯。使用该函数时要小心，因为它会产生大量输出！ |
...
1. [`https://php.net/manual/en/class.throwable.php`](https://php.net/manual/en/class.throwable.php)
2. [`https://php.net/manual/en/errorfunc.constants.php`](https://php.net/manual/en/errorfunc.constants.php)
3. [`https://php.net/manual/en/function.set-error-handler.php`](https://php.net/manual/en/function.set-error-handler.php)
4. [`https://php.net/manual/en/language.types.callable.php`](https://php.net/manual/en/language.types.callable.php)
