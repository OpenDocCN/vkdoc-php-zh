...
1.  设计模式:可重用面向对象软件的元素，第 349 页
2.  [`https://laravel.com/docs/master/encryption`](https://laravel.com/docs/master/encryption)
3.  [`https://github.com/kdocki/larasign/tree/strategy/app/Noises`](https://github.com/kdocki/larasign/tree/strategy/app/Noises)