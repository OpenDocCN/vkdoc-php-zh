...
在企业级环境中，我们可以集成 LDAP 以实现集中式认证和授权。
...
![图 6-1 HTTP 连接工作流程生命周期](img/609480_1_En_6_Fig1_HTML.jpg)
...
![图 6-2 HTTPS 连接工作流程生命周期](img/609480_1_En_6_Fig2_HTML.jpg)
...
![图 6-4 安全 API 通信中的请求-响应生命周期](img/609480_1_En_6_Fig4_HTML.jpg)
