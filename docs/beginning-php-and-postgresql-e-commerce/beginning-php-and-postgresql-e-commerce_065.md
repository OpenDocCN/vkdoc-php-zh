...
648XCH07a.qxd 10/25/06 10:56 PM Page 216
...
1.  在 `presentation/templates` 文件夹中创建一个名为 `admin_departments.tpl` 的新模板文件，并向其中添加以下代码：
    ...
    648XCH07a.qxd 10/25/06 10:56 PM Page 217
    
    C H A P T E R 7 ■ C ATA L O G A D M I N I S T R AT I O N
    ...
    **217**
    ...
    648XCH07a.qxd 10/25/06 10:56 PM Page 218
...
<ol start="2">
<li>在 <code>presentation/smarty_plugins</code> 文件夹中创建一个名为 <code>function.load_admin_departments.php</code> 的新插件文件，并添加以下内容：</li>
</ol>
