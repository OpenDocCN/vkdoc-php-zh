...
![img/514068_1_En_13_Fig1_HTML.png](img/514068_1_En_13_Fig1_HTML.png)
...
![图 14-17 刷新后的注册页面](img/514068_1_En_14_Fig17_HTML.png)

尝试用一些示例值填写字段详情，然后单击“注册”按钮，即可查看表单 POST 提交请求的实际情况。提交后，页面将类似于图 14-18。

![图 14-18 注册成功页面](img/514068_1_En_14_Fig18_HTML.jpg)
...
![图 14-19 模型创建输出](img/514068_1_En_14_Fig19_HTML.png)
...
![图 14-20 更新后的注册输出](img/514068_1_En_14_Fig20_HTML.jpg)

我们再来检查一下数据库中以加密密码形式存储的用户详情，如图 14-21 所示。

![图 14-21 Laravel 数据库加密密码](img/514068_1_En_14_Fig21_HTML.png)
