...
1. 设计模式:可重用面向对象软件的元素，第 208 页
2. [`https://laravel.com/docs/5.3/facades`](https://laravel.com/docs/5.3/facades)
3. [`www.reddit.com/r/PHP/comments/1zpm0y/laravel_lets_talk_about_facades`](http://www.reddit.com/r/PHP/comments/1zpm0y/laravel_lets_talk_about_facades)
4. [`www.youtube.com/watch?v=HZJSccRDKZc`](http://www.youtube.com/watch?v=HZJSccRDKZc)