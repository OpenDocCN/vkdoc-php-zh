...
1.  设计模式:可重用面向对象软件的元素，第 366 页
2.  [`www.destroyallsoftware.com/talks/wat`](http://www.destroyallsoftware.com/talks/wat)
3.  [`http://en.wikipedia.org/wiki/Double_dispatch`](http://en.wikipedia.org/wiki/Double_dispatch)
4.  [`http://en.wikipedia.org/wiki/Function_overloading`](http://en.wikipedia.org/wiki/Function_overloading)
5.  [`https://twitter.com/kdocki`](https://twitter.com/kdocki)
6.  [`http://php.net/manual/en/function.is-a.php`](http://php.net/manual/en/function.is-a.php)