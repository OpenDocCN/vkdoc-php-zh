...
图 17-2 六角形的基本方案，包括一些输入请求(浏览器和 API)
...
Listing 17-8 An Implementation of an Event as Defined by the Interface (Port) Described in the EventInterface Interface
```
