...
1. [`https://dev.mysql.com/doc/refman/5.7/en/integer-types.html`](https://dev.mysql.com/doc/refman/5.7/en/integer-types.html)
2. [`https://secure.php.net/manual/en/pdostatement.fetch.php`](https://secure.php.net/manual/en/pdostatement.fetch.php)