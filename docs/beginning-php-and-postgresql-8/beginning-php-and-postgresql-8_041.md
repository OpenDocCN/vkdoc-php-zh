...
导航路径，或更亲切地称之为*面包屑导航*，在 Web 应用程序中经常被实现，因为它为用户提供了一种直观可见且易于理解的导航辅助工具。将用户当前的位置分解为一系列超链接路径，这些路径提供了当前文档相对于整个网站位置的概要视图，这不仅为用户提供了比浏览器更实用、更高效的导航工具，还有助于补充甚至替代典型网站的本地菜单系统。
