...
Listing 10-1 An Implementation of the Request When a Claim Is Submitted, Including the Validation Rules
...
Listing 10-2 The Claim Model with the Date of Service Validation Handled Explicitly in the `checkDateOfService()` Method
...
Listing 10-3 An Example `ClaimObserver` Class with the Logic That Validates the Date of Service Before It Is Saved to the Database
