...
`else if(($_SERVER['HTTP_REFERER'] == '`[`http://127.0.0.1:8080/mysite/bgchapter8/ExampleFile8/e8login.php`](http://127.0.0.1:8080/mysite/bgchapter8/ExampleFile8/e8login.php)`') || ($_SERVER['HTTP_REFERER'] == '`[`http://127.0.0.1:8080/mysite/bgchapter8/ExampleFile8/e8lab.php`](http://127.0.0.1:8080/mysite/bgchapter8/ExampleFile8/e8lab.php)
...
`else if(($_SERVER['HTTP_REFERER'] == '`[`http://127.0.0.1:8080/mysite/bgchapter8/login.php`](http://127.0.0.1:8080/mysite/bgchapter8/login.php)`') || ($_SERVER['HTTP_REFERER'] == '`[`http://127.0.0.1:8080/mysite/bgchapter8/lab.php`](http://127.0.0.1:8080/mysite/bgchapter8/lab.php)
