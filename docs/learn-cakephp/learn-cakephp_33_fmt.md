...
```php
$model = $this->getMockForModel('Categories', ['hasPostsCount']);
$model->expects($this->any())
    ->method('hasPostsCount')
    ->with($this->logicalOr(5, 10, $this->anything()))
    ->will(
        $this->returnCallback(
            function ($param) {
                if ($param == 5) {
...
$this->assertEquals([5, 10, 15],$model->hasPostsCount(5));
$this->assertEquals([10, 20, 30], $model->hasPostsCount(10));
$this->assertEquals(false, $model->hasPostsCount(1));
```
