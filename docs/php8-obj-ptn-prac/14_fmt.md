...
你有没有制定过让一切都好起来的时间表？你从一个任务开始:也许是代码或者一个学校项目。又大又吓人，潜伏着失败。但是你拿出一张纸，把它分成容易管理的任务。你决定要读的书和要写的组件。也许你用不同的颜色突出显示任务。事实证明，就个人而言，没有一项任务真的那么可怕。渐渐地，随着你的计划，你征服了最后期限。只要每天做一点点，就没事了。你可以放松。
