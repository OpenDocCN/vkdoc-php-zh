...
{% if template contains 'product' %}
  ...
  {% if product.vendor == blank %}
    ...
    <meta name="twitter:data1" content="{{ product.price | money_without_currency }}" />
  {% else %}
    <meta name="twitter:label1" content="Vendor" />
    <meta name="twitter:data1" content="{{ product.vendor }}" />
  {% endif %}
{% elsif template contains 'article' %}
  <!-- Article template Twitter Card markup -->
{% endif %}
```
*清单 9-7 示例 snippets/twitter-card.liquid*
