...
<!--Fonts via fonts.com-->
<script type="text/javascript" src="http://fast.fonts.com/jsapi/a09d5d16-57fd-447d-a0f6-73443033d2de.js"></script>
...
If you have a question that wasn't answered, please [email the presenter](mailto:jason@copterlabs.com).
...
调整标题和正文样式，更新两个现有规则以包括`h3`，添加一个新的`h3`规则，并修改`p`，如下面`main.css`中的“基本字体样式”部分所示：
        ...
        <form id="close-this-room">
            <label>
                ...
                <input type="text" name="room-url"
                       value="realtime.local/room/1234"
                       disabled />
            </label>
