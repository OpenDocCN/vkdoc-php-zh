...
> **Note**
>
> `__CLASS__`是所谓的魔法常数，在这种情况下，它返回调用它的类的名称。有几个可用的魔术常数；你可以在 [PHP 手册](http://us3.php.net/manual/en/language.constants.predefined.php) 中读到更多关于它们的内容。
