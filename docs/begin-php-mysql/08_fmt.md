...
Listing 8-2 Proper Exception Handling
...
为`Error`类定义了许多子类来处理特殊情况。这些是`ArithmeticError`、`DivisionByZeroError`、`AssertionError`、`ParseError`和`TypeError`。
